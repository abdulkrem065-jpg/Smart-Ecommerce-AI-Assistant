...
const DEFAULT_TEMPLATES: NicheConfig[] = [
  ...
  },
  {
    ...
    name: '🌟 Aldhibani Hybrid Hyper & Vip Solutions',
    subtitle: 'المنصة الرقمية المتكاملة: تموين غذائي، أجهزة إلكترونية، شحن ألعاب، ورصيد فوري للشبكات',
    aiBehavior: 'Comprehensive Hybrid Hyper, grocery, electronics top-up, and localized Yemen billing assistant.',
    themeColor: 'emerald',
    badgeText: 'مجمع الهايبر والخدمات الهجين',
    accentClass: 'text-emerald-400',
    backgroundClass: 'from-[#031c0a] to-[#000502]',
    gradientClass: 'from-emerald-500 to-green-500',
    iconName: 'ShoppingBag',
    categories: [
      { id: 'cat-sm-1', name: 'المواد الغذائية والتوابل الفاخرة 🌾', englishName: 'staples' },
      { id: 'cat-sm-2', name: 'أجهزة إلكترونية وملحقات الشبكات 🔌', englishName: 'electronics' },
      { id: 'cat-sm-3', name: 'شحن فوري مباشر للألعاب والشدات 🎮', englishName: 'game_charge' },
      { id: 'cat-sm-4', name: 'كروت رصيد اتصالات وفواتير فورية 📱', englishName: 'telecom_topup' }
    ],
    products: [
      {
        id: 'p-sm-1',
        ...
        category: 'المواد الغذائية والتوابل الفاخرة 🌾',
        price: 45.0,
        price_sar: 45.0,
        price_yer: 18000,
      ...
      {
        id: 'p-sm-2',
        name: 'قهوة بن يمني مطحون فاخر بالهيل (وزن نصف كيلو) ☕',
        description: 'قهوة يمنية أصيلة بخلاصة الهيل والزنجبيل والبهارات العربية العطرة المصنوعة يدوياً بمستودعاتنا.',
        category: 'المواد الغذائية والتوابل الفاخرة 🌾',
        price: 65.0,
        price_sar: 65.0,
        price_yer: 26050,
      ...
      {
        id: 'p-sm-3',
        name: 'راوتر الجيل الخامس المنزلي هواوي Pro 5G المتنقل 🔌',
        description: 'راوتر سرعات فائق السرعة يدعم كافة شبكات الاتصالات اليمنية والدولية ومزود بـ 4 منافذ قوية لتغطية المنزل.',
        category: 'أجهزة إلكترونية وملحقات الشبكات 🔌',
        price: 180.0,
        price_sar: 180.0,
        price_yer: 72000,
      ...
      {
        id: 'p-sm-4',
        name: 'شحن شدات ببجي موبايل (660 شدة فوري) بالمعرف 🎮',
        description: 'باقة شدات ببجي الرسمية المعتمدة يتم شحنها وتفعيلها فورياً على الأيدي الخاص باللاعب مباشرة بمحرّك السلة.',
        category: 'شحن فوري مباشر للألعاب والشدات 🎮',
        price: 12.0,
        price_sar: 12.0,
        price_yer: 4800,
        image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=500&q=80',
      ...
      {
        id: 'p-sm-5',
        name: 'باقة رصيد شحن فوري يمن موبايل بقيمة (1000 ريال) 📱',
        description: 'شحن رصيد وباقات إنترنت يمن موبايل مباشر عبر بوابات الاتصال والربط السحابي التلقائي فوراً.',
        category: 'كروت رصيد اتصالات وفواتير فورية 📱',
        price: 2.5,
        price_sar: 2.5,
        price_yer: 1000,
        ...
        code: 'YM-1000',
        isApiProduct: true,
        apiRequiredField: 'رقم الموبايل المراد شحنه (77xxxxxxx)',
        apiProvider: 'etisalatonline'
      }
    ]
  },
  {
