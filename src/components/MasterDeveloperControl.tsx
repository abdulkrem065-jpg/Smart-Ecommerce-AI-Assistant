...
export const MasterDeveloperControl: React.FC<MasterDeveloperControlProps> = ({
  ...
  const [projects, setProjects] = useState<any[]>(() => {
    ...
    return [
      {
        id: "p-supermarket",
        name: "هايبرماركت ومستودعات آل ذيبان للتموين المركزي",
        englishName: "Al-Dhibani Food & Supermarket Central",
        currency: "YER",
        rate: 1,
        margin: 10,
        status: "active",
        ...
        phone: "7770493341",
        subscribers: [
          { id: "s-1", name: "فرع صنعاء - التحرير", phone: "777111222", role: "مشرف", expiry: "2027-12-31", active: true, features: ["grocery", "branches", "api"] },
          { id: "s-2", name: "فرع عدن - الشيخ عثمان", phone: "773334444", role: "موظف", expiry: "2026-08-15", active: true, features: ["grocery"] },
          { id: "s-3", name: "مشترك مأرب - الروضة (خارجى)", phone: "770001111", role: "مالك متجر", expiry: "2026-05-10", active: false, features: ["grocery", "smart_margin"] }
        ]
      },
      {
        id: "p-gaming",
        name: "منصة آل ذيبان لخدمات الجيمنج ومفاتيح الشحن الفوري",
        englishName: "Al-Dhibani VIP Gaming & Digital Services",
        currency: "SAR",
        rate: 140,
        margin: 15,
        status: "active",
        ...
        phone: "775555555",
        subscribers: [
          { id: "s-4", name: "سوبرماركت التاج لشحن الألعاب", phone: "771888999", role: "مالك متجر", expiry: "2027-01-01", active: true, features: ["gaming", "api"] }
        ]
      },
      {
        id: "p-pharmacy",
        name: "صيدلية ومستلزمات العناية والرعاية الطبية المنزلية",
        englishName: "Smart Care Medicine & Pharma Hub",
        currency: "USD",
        rate: 530,
        margin: 8,
        status: "active",
        ...
        phone: "776666666",
        subscribers: [
          { id: "s-5", name: "الفرع الطبي الأول - تعز", phone: "770014444", role: "مشرف", expiry: "2027-06-30", active: true, features: ["prescription", "branches"] }
        ]
      },
      {
        id: "p-law",
        name: "مجموعة آل ذيبان للاستشارات وحجز تذاكر المرافعات",
        englishName: "Al-Dhibani Digital Law & Legal Advisors",
        currency: "SAR",
        rate: 140,
        margin: 12,
        status: "active",
        ...
        phone: "774444444",
        subscribers: [
          { id: "s-6", name: "مستشار الفرع الرياض القانوني", phone: "772223333", role: "مالك متجر", expiry: "2026-04-18", active: true, features: ["consulting"] }
        ]
      }
    ];
  });
                    ...
                    <div key={proj.id} className="transition-all">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-xs font-black text-purple-300 hover:text-white transition-colors">
